...
*   **Source Path:** `.codex-flow/inputs/specifications.md`
*   **Target Path:** `.codex-flow/artifacts/indexing/indexed_specs.md`
...
**Source Text (Read from `.codex-flow/inputs/specifications.md`):**
```
### Installation & Usage
...
**Resulting Content (Written to `.codex-flow/artifacts/indexing/indexed_specs.md`):**
```
### Installation & Usage
