...
1.  **User Requirements (source):**
    - Read and synthesize ALL files under `.codex-flow/input/specifications/` (recursive). Treat the concatenated contents, ordered by filename, as the authoritative requirements input.
