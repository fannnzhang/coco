...
1.  **User Requirements:**
    ~~~
    specifications: `.codex-flow/input/specification.md` — demand packets (Markdown). Read every file recursively in lexical order.
    ~~~
...
{arch_output_format}: `.codex-flow/prompts/output-formats/architecture-output.md`
