...
3. Input definitions:
   - `design.md`: the finalized design artifact at `specs/<spec-name>/design.md`.
   - `requirements.md`: structured requirement list at `specs/<spec-name>/requirements.md`.
...
2. Populate `specs/<spec-name>/tasks.md` using `templates/tasks.md`. Keep section order intact, starting with a concise "Phases Overview" that summarizes each phase in one sentence, highlighting dependencies.
