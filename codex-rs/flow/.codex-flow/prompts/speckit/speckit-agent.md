...
- Limit edits to `.codex-flow/runtime/specs/<spec-name>/` and `.codex-flow/runtime/speckit/spec-agent-output/` unless additional directories are explicitly required.
